                                ...
                                <div class="carousel-box">
                                    <a href="{{ json_decode(get_setting('home_slider_links'), true)[$key] }}">
                                        <img
                                            ...
                                            @if (null!=uploaded_asset($slider_images[$key]))
                                                src="{{ uploaded_asset($slider_images[$key])}} "
                                            @endif
                                            @if (null!=json_decode(get_setting('home_slider_links'), true)[$key]))
                                                src="{{ json_decode(get_setting('home_slider_links'), true)[$key] }}"
                                            @endif
